...
pkgdatadir = $(datadir)/robinhood
pkgincludedir = $(includedir)/robinhood
pkglibdir = $(libdir)/robinhood
pkglibexecdir = $(libexecdir)/robinhood
...
#am__append_1 = --with recovtools
#am__append_2 = --without common_rpms
am__append_3 = --with mysql
#am__append_4 = --with sqlite
am__append_5 = --with lhsm
#am__append_6 = --without lhsm
#am__append_7 = --with shook
am__append_8 = --without shook
am__append_9 = --with backup
#am__append_10 = --without backup
am__append_11 = --with jemalloc
#am__append_12 = --without jemalloc
subdir = .
...
CONFIG_CLEAN_FILES = robinhood.spec doc/doxygen/doxygen.cfg
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/robinhood.spec.in \
	...
	$(top_srcdir)/doc/doxygen/doxygen.cfg.in COPYING ChangeLog \
...
ACLOCAL = ${SHELL} /root/robinhood/autotools/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} /root/robinhood/autotools/missing autoconf
AUTOHEADER = ${SHELL} /root/robinhood/autotools/missing autoheader
AUTOMAKE = ${SHELL} /root/robinhood/autotools/missing automake-1.16
AWK = gawk
CC = gcc
CCDEPMODE = depmode=gcc3
CC_OPT = -Wall -Werror -Wstrict-prototypes -Wmissing-prototypes -Wmissing-declarations -std=gnu99 -Wno-variadic-macros
CFLAGS = -g -O2 -I/usr/include/glib-2.0 -I/usr/lib64/glib-2.0/include  -pthread -I/usr/include/glib-2.0 -I/usr/lib64/glib-2.0/include  -I/root/lustre-2.14.0_ddn54/lustre/include -D_MDS_STAT_SUPPORT  -I$(top_srcdir)/src/include
CONFDIR = /etc
CPP = gcc -E
CPPFLAGS = 
CYGPATH_W = echo
DB_CFLAGS = -D_MYSQL -I/usr/include/mysql -I/usr/include/mysql/mysql -D_MYSQL5
DB_LDFLAGS = -L/usr/lib64/ -lmariadb
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DLLTOOL = false
DSYMUTIL = 
DUMPBIN = 
DV_CMD = lfs data_version
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
LDEFINES = --define="lversion 2.14" --define="lpackage lustre-client"
LDFLAGS =  -lglib-2.0  -lgthread-2.0 -pthread -lglib-2.0  -L/root/lustre-2.14.0_ddn54/lustre/utils -ljemalloc
LEX = flex
LEXLIB = 
...
LT_SYS_LIBRARY_PATH = 
LUSTRE = 
MAKEINFO = ${SHELL} /root/robinhood/autotools/missing makeinfo
MANIFEST_TOOL = :
...
OTOOL64 = 
PACKAGE = robinhood
PACKAGE_BUGREPORT = robinhood-support@lists.sourceforge.net
PACKAGE_NAME = robinhood
PACKAGE_STRING = robinhood 3.1.7
PACKAGE_TARNAME = robinhood
PACKAGE_URL = 
...
YFLAGS = 
abs_builddir = /root/robinhood
abs_srcdir = /root/robinhood
abs_top_builddir = /root/robinhood
abs_top_srcdir = /root/robinhood
ac_configure_args =  '--enable-lustre' '--with-lustre=/root/lustre-2.14.0_ddn54' '--enable-mds-stat'
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /root/robinhood/autotools/install-sh
...
rpm_dir = `pwd`/rpms
#rpmbuild_opt = --without lustre $(am__append_2) \
#	$(am__append_3) $(am__append_4) $(am__append_5) \
#	$(am__append_6) $(am__append_7) $(am__append_8) \
#	$(am__append_9) $(am__append_10) \
#	$(am__append_11) $(am__append_12) \
#	--define="configure_flags  '--enable-lustre' '--with-lustre=/root/lustre-2.14.0_ddn54' '--enable-mds-stat'"
rpmbuild_opt = --with lustre --define="lversion 2.14" --define="lpackage lustre-client" $(am__append_1) \
...
$(am__aclocal_m4_deps):
robinhood.spec: $(top_builddir)/config.status $(srcdir)/robinhood.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
doc/doxygen/doxygen.cfg: $(top_builddir)/config.status $(top_srcdir)/doc/doxygen/doxygen.cfg.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
...
rpm: robinhood.spec mydist
	...
	rpmbuild $(rpmbuild_opt) --define="_topdir $(rpm_dir)" --define="_prefix $(prefix)" \
		--define="dbversion $(dbversion)" --define="_sysconfdir /etc" \
...
cppcheck:
	cppcheck -j12 -v --force --enable=all -I`pwd`/src/include -DHAVE_CONFIG_H  -D_MYSQL -I/usr/include/mysql -I/usr/include/mysql/mysql -D_MYSQL5 src/
